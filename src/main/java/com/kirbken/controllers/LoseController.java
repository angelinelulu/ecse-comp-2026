...
public class LoseController implements FxController {
  ...
  /**
   * Configures this screen for a draw / timeout scenario where both players lost — shows
   * Player 1's sprite (no second sprite) with a combined stats panel for both players.
   */
  public void setBothLosers(CharacterProfile p1Profile, MatchStats p1Stats,

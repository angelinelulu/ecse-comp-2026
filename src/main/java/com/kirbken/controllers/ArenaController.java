...
public class ArenaController {
    ...
    public void initialize() {
        ...
        // Drop menu audio track
        musicManager.pause();

        // FIX: Safely route the arena asset directly into the global ecosystem 
        musicManager.loadSound("arena", "/sounds/arenaaudio.mp3");
        
        // Sync visual state check on load to match previous screen choices
